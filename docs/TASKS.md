...
- **ended:** a task for which scheduled window is ended. This happens only for window schedule with defined _stop_timestamp_. An ended task is not resumable because the schedule will not fire again (stop time cannot be pointed in the past).


![statediagram](https://cloud.githubusercontent.com/assets/11335874/23064521/c535a774-f510-11e6-9e4b-0706dcda2f9b.png)
