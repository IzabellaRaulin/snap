...
Communication between Snap and plugins uses RPC either through HTTP or TCP protocols. The data that plugins report to snap is in the form of JSON or GOB CODEC.
