...
[[ "$SNAP_TEST_TYPE" =~ ^(small|medium|large|legacy|build|legacyiza)$ ]] || _error "invalid/missing SNAP_TEST_TYPE (value must be 'small', 'medium', 'large', 'legacy', or 'build' received:${SNAP_TEST_TYPE}"
