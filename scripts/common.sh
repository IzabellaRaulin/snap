...
test_dirs=$(find . -type f -name '*.go' -not -path "./.*" -not -path "*/_*" -not -path "./Godeps/*" -not -path "./vendor/*" -not -path "./scripts/*" -not -path "./mgmt/*" -not -path "./pkg/*" -not -path "./grpc/*" -not -path "./core/*" -not -path "./scheduler/*" -not -path "./plugin/*"  -print0 | xargs -0 -n1 dirname | sort -u)
