...
Copyright 2015-16 Intel Corporation
...
// GetMetrics retrieves all metrics given a namespace (many namespaces could be specified by using wildcard or tupple) and version.
// If provided a version of -1 the latest plugin will be returned.
